...
class Fee():
    def __init__(self, master):
        ...
        # ==================================================Frames===================================================
        Main_Frame = Frame(self.master, bg='#114802')
        Main_Frame.grid()

        Title_Frame = LabelFrame(
            Main_Frame, width=1350, height=100, bg='#8DCD0D', relief='ridge', bd=15)
        ...
        # ===================================================Labels================================================
        self.recpt_label = Label(Frame_1, text='Registeration No. : ', font=(
            'arial', 14, 'bold'), bg='#5ECC3F')
