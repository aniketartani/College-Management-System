...
class Library:
       ...
       #=====================================================Frames=====================================================
              Main_Frame = Frame(self.root, bg = '#580457')
              Main_Frame.grid()

              Title_Frame_1 = Frame(Main_Frame, width = 1350, bg = '#F315B8', relief = RIDGE, bd = 15, padx = 20)
              ...
              Button_Frame = Frame(Main_Frame, width = 1350, height = 50, relief = RIDGE, bd = 10, bg = '#F315B8')
              Button_Frame.pack(side = BOTTOM)

              Detail_Frame = Frame(Main_Frame, width = 1350, height = 100, relief = RIDGE, bd = 10, bg = 'PINK')
              Detail_Frame.pack(side = BOTTOM)

              Data_Frame = Frame(Main_Frame, width = 1350, height = 400, relief = RIDGE, bd = 15, bg = '#F315B8')
              Data_Frame.pack(side = BOTTOM)

              Frame_1 = LabelFrame(Data_Frame, width = 800, height = 400, relief = RIDGE, bd = 10, bg = '#BF55FC', \
                              text = "Library Membership Info:", padx = 20, font = ('arial',15,'bold'))
              Frame_1.pack(side = LEFT, padx = 3)

              Frame_2 = LabelFrame(Data_Frame, width = 550, height = 400, relief = RIDGE, bd = 10, bg = '#BF55FC', \
       ...
       #================================================Labels========================================================
              ...
              self.Label_2 = Label(Frame_1, text = 'Registeration No.', font = ('arial',13,'bold'), pady = 2, \
                                   bg = '#BF55FC' )
              ...
              self.Label_5 = Label(Frame_1, text = 'Hostel/day-scholar', font = ('arial',13,'bold'), pady = 2, \
                                   bg = '#BF55FC' )
              self.Label_5.grid(row = 4, column = 0, sticky = W)
              self.Label_6 = Label(Frame_1, text = 'Procter Name', font = ('arial',13,'bold'), pady = 2, \
                                   bg = '#BF55FC' )
